    ...
    DQNAgent.prototype = {
        ...
        act: function (slist) {
            ...
            if (Math.random() < this.epsilon) {
                ...
                randomElement.innerHTML = 200;
                randomElement.style.width = '400px';
            } else {
