...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DQNAgent__ = __webpack_require__(28);
...
class RlDqn {
    constructor(learningEnabled, numberOfStates, previousSavedData) {
        ...
        this._agent = new __WEBPACK_IMPORTED_MODULE_0__DQNAgent__["a" /* DQNAgent */](env, spec);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__neural_network_saves_view_port_5_5_0_1_games_10000__ = __webpack_require__(30);
...
DQNAgentc.prototype = {
    ...
    act: function (slist) {
        ...
        var s = new __WEBPACK_IMPORTED_MODULE_0__Recurrent__["a" /* Recurrent */].Mat(this.ns, 1);
        s.setFrom(slist);
        ...
        if (Math.random() < this.epsilon) {
            ...
            a = __WEBPACK_IMPORTED_MODULE_0__Recurrent__["a" /* Recurrent */].maxi(amat.w); // returns index of argmax action
        }
