...
var ctx=self;var WorkerInputActions={Tick:'TICK',ClearStatsAndNewGame:'CLEAR_STATS_AND_NEW_GAME',SetLudicrousSpeedEnabled:'SET_LUDICROUS_SPEED_ENABLED',RequestStats:'REQUEST_STATS',UserMove:'USER_MOVE',SetAgentIndex:'SET_AGENT_INDEX',ClearAgentBrain:'CLEAR_AGENT_BRAIN',RequestAgentBrainExport:'REQUEST_AGENT_BRAIN_EXPORT'};var WorkerOutputActions={UpdateState:'UPDATE_STATE',ExportAgentBrainFulfilled:'EXPORT_AGENT_BRAIN_FULFILLED'};var gameRunner=new GameRunner_GameRunner();var ludicrousSpeedTicker=new src_LudicrousSpeedTicker(gameRunner.tick,src_config.ludicrousSpeed);var agentInstances=[];var agentIndex=0;var worker_clearStatsAndNewGame=function clearStatsAndNewGame(){if(!agentInstances[agentIndex]){agentInstances[agentIndex]=new agents[agentIndex].class();}gameRunner.setRenderingEnabled(!ludicrousSpeedTicker.ludicrousSpeedEnabled);gameRunner.clearStats();gameRunner.newGame(agentInstances[agentIndex]);ludicrousSpeedTicker.handleAgentChange();};/**
