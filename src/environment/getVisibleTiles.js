...
//     if (state.costs[state.position[0]][state.position[1]] === 0) {
...
//             while (typeof state.costs[x] !== 'undefined' && typeof state.costs[x][y] !== 'undefined' && !lastWasWall) { //@todo Don't call this func to increase performance
//                 visibles[x][y] = 1;
...
//                     if (typeof state.costs[xAdj] !== 'undefined' && typeof state.costs[xAdj][yAdj] !== 'undefined') {
...
//             if (typeof state.costs[checkPosition[0]] !== 'undefined' && typeof state.costs[checkPosition[0]][checkPosition[1]] !== 'undefined') {
