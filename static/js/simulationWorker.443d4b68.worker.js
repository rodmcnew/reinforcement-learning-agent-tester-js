...
batchSizeAdjustmentMultiplier:2}};/* harmony default export */ var src_config = (config_config);
...
var LookAhead9x3_LookAhead9x3=/*#__PURE__*/function(){function LookAhead9x3(){_classCallCheck(this,LookAhead9x3);this._state={lastAction:null};this.feelerPaths=generateFeelerPaths(4);}_createClass(LookAhead9x3,[{key:"getAction",value:function getAction(lastAction,lastReward,observationMatrix){var action=getActionViaFeelers(observationMatrix,this.feelerPaths,this._state.lastAction);this._state.lastAction=action;return[action,{}];}},{key:"newGame",value:function newGame(){}}],[{key:"getName",value:function getName(){return'Hand Programmed - Look Ahead - 9x3 Viewport';}},{key:"getDescription",value:function getDescription(){return'This agent was programmed by hand. It looks ahead in time by several actions.';}}]);return LookAhead9x3;}();
...
// CONCATENATED MODULE: ./src/modules/simulation-manager/GameRunner.js
...
// CONCATENATED MODULE: ./src/modules/simulation-manager/LudicrousSpeedTicker.js
/**
...
this.ludicrousBatchSize=Math.max(this.ludicrousBatchSize*this.config.batchSizeAdjustmentMultiplier,1);}}/**
     ...
     */},{key:"setLudicrousSpeedTickingEnabled",value:function setLudicrousSpeedTickingEnabled(tickingEnabled){var ludicrousSpeedWasEnabled=this.ludicrousSpeedEnabled;this.ludicrousSpeedEnabled=tickingEnabled;if(this.ludicrousSpeedEnabled&&!ludicrousSpeedWasEnabled){this.startTickerLoop();}}}]);return LudicrousSpeedTicker;}();/* harmony default export */ var simulation_manager_LudicrousSpeedTicker = (LudicrousSpeedTicker_LudicrousSpeedTicker);
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--5-oneOf-2!./src/modules/simulation-manager/simulationWorker.js
var ctx=self;var WorkerInputActions={Tick:'TICK',ClearStatsAndNewGame:'CLEAR_STATS_AND_NEW_GAME',SetLudicrousSpeedEnabled:'SET_LUDICROUS_SPEED_ENABLED',RequestStats:'REQUEST_STATS',UserMove:'USER_MOVE',SetAgentIndex:'SET_AGENT_INDEX',ClearAgentBrain:'CLEAR_AGENT_BRAIN',RequestAgentBrainExport:'REQUEST_AGENT_BRAIN_EXPORT'};var WorkerOutputActions={UpdateState:'UPDATE_STATE',ExportAgentBrainFulfilled:'EXPORT_AGENT_BRAIN_FULFILLED'};var gameRunner=new GameRunner_GameRunner();var ludicrousSpeedTicker=new simulation_manager_LudicrousSpeedTicker(gameRunner.tick,src_config.ludicrousSpeed);var agentInstances=[];var agentIndex=0;var simulationWorker_clearStatsAndNewGame=function clearStatsAndNewGame(){if(!agentInstances[agentIndex]){agentInstances[agentIndex]=new agents[agentIndex].class();}gameRunner.setRenderingEnabled(!ludicrousSpeedTicker.ludicrousSpeedEnabled);gameRunner.clearStats();gameRunner.newGame(agentInstances[agentIndex]);ludicrousSpeedTicker.handleAgentChange();};/**
